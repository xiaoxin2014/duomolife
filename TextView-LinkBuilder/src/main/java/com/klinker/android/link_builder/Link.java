...
//    网址是否特殊处理 替换成网页链接
    ...
    public Link(Link link) {
        ...
        this.bgColor = link.getBgColor();
        this.textSize = link.getTextSize();
        this.bgRadius = link.getBgRadius();
        this.urlReplace = link.isUrlReplace();
    }
     ...
     * @return
     */
    public Link setTextSize(int textSize) {
     ...
     * @return
     */
    public Link setBgColor(int bgColor) {
     ...
     * @return
     */
    public Link setBgRadius(int bgRadius) {
     ...
     * @param urlReplace
     */
    public Link setUrlReplace(boolean urlReplace) {
        this.urlReplace = urlReplace;
        return this;
    }

    public boolean isUrlReplace() {
        return urlReplace;
    }
