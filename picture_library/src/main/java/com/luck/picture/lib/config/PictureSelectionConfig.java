...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public List<LocalMediaC> selectionMedias;

    private void reset() {
        mimeType = PictureConfigC.TYPE_IMAGE;
        camera = false;
        themeStyleId = R.style.picture_default_style;
        selectionMode = PictureConfigC.MULTIPLE;
        maxSelectNum = 9;
        minSelectNum = 0;
        videoQuality = 1;
        ...
        minimumCompressSize = PictureConfigC.MAX_COMPRESS_SIZE;
        imageSpanCount = 4;
        overrideWidth = 0;
        overrideHeight = 0;
        isCompress = false;
    ...
    protected PictureSelectionConfig(Parcel in) {
        ...
        this.selectionMedias = in.createTypedArrayList(LocalMediaC.CREATOR);
    }
