...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<LocalMediaC> images = new ArrayList<LocalMediaC>();
    private List<LocalMediaC> selectImages = new ArrayList<LocalMediaC>();
    private boolean enablePreview;
    private int selectMode = PictureConfigC.MULTIPLE;
    ...
    public void bindImagesData(List<LocalMediaC> images) {
        this.images = images;
        notifyDataSetChanged();
    }

    public void bindSelectImages(List<LocalMediaC> images) {
        // 这里重新构构造一个新集合，不然会产生已选集合一变，结果集合也会添加的问题
        List<LocalMediaC> selection = new ArrayList<>();
    ...
    public List<LocalMediaC> getSelectedImages() {
    ...
    public List<LocalMediaC> getImages() {
        if (images == null) {
    ...
    public int getItemViewType(int position) {
        if (showCamera && position == 0) {
            return PictureConfigC.TYPE_CAMERA;
        } else {
            return PictureConfigC.TYPE_PICTURE;
        }
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == PictureConfigC.TYPE_CAMERA) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfigC.TYPE_CAMERA) {
            ...
            final LocalMediaC image = images.get(showCamera ? position - 1 : position);
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                StringUtils.modifyTextViewDrawable(contentHolder.tv_duration, drawable, 0);
                contentHolder.tv_duration.setVisibility(mediaMimeType == PictureConfigC.TYPE_VIDEO
            ...
            contentHolder.contentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean eqResult =
                            mediaMimeType == PictureConfigC.TYPE_IMAGE && enablePreview
                                    || mediaMimeType == PictureConfigC.TYPE_VIDEO && (enablePreviewVideo
                                    || selectMode == PictureConfigC.SINGLE)
                                    || mediaMimeType == PictureConfigC.TYPE_AUDIO && (enablePreviewAudio
                                    || selectMode == PictureConfigC.SINGLE);
                    if (eqResult) {
     ...
     * 选择按钮更新
     */
    private void notifyCheckChanged(ViewHolder viewHolder, LocalMediaC imageBean) {
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMediaC image) {
        ...
        if (isChecked) {
            ...
            if (selectMode == PictureConfigC.SINGLE) {
    ...
    public interface OnPhotoSelectChangedListener {
         ...
         * @param selectImages
         */
        void onChange(List<LocalMediaC> selectImages);
         ...
         * @param position
         */
        void onPictureClick(LocalMediaC media, int position);
    }
