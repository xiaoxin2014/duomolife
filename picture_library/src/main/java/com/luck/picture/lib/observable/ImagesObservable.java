...
public class ImagesObservable implements SubjectListener {
    ...
    private List<LocalMediaC> medias;
    private List<LocalMediaC> selectedImages;
     ...
     * @param list
     */
    public void saveLocalMedia(List<LocalMediaC> list) {
        medias = list;
    }
     ...
     * 读取图片
     */
    public List<LocalMediaC> readLocalMedias() {
        if (medias == null) {
            medias = new ArrayList<>();
        }
        return medias;
     ...
     * 读取选中的图片
     */
    public List<LocalMediaC> readSelectLocalMedias() {
