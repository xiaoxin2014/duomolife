...
public class EventEntity implements Parcelable {
    public int what;
    public int position;
    public List<LocalMediaC> medias = new ArrayList<>();
    ...
    public EventEntity(int what, List<LocalMediaC> medias) {
        super();
        this.what = what;
        this.medias = medias;
    }
    ...
    public EventEntity(int what, List<LocalMediaC> medias, int position) {
        super();
        this.what = what;
        this.position = position;
        this.medias = medias;
    ...
    protected EventEntity(Parcel in) {
        ...
        this.medias = in.createTypedArrayList(LocalMediaC.CREATOR);
    }
