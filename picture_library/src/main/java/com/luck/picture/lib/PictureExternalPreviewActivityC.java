 ...
 * data：17/01/18
 */
public class PictureExternalPreviewActivityC extends PictureBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture_activity_external_preview_c);
        ...
        directory_path = getIntent().getStringExtra(PictureConfigC.DIRECTORY_PATH);
        images = (List<LocalMediaC>) getIntent().getSerializableExtra(PictureConfigC.EXTRA_PREVIEW_SELECT_LIST);
...
// 常规图控件
            ...
            if (media != null) {
                ...
                if (isGif && !media.isCompressed()) {
                    ...
                    Glide.with(PictureExternalPreviewActivityC.this)
                            .asGif()
                            .apply(gifOptions)
                            .load(path)
                ...
                final GestureDetector gestureDetector = new GestureDetector(PictureExternalPreviewActivityC.this, new GestureDetector.SimpleOnGestureListener() {
                    @Override
                ...
                scaleImageView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        if (rxPermissions == null) {
                            rxPermissions = new RxPermissions(PictureExternalPreviewActivityC.this);
                        }
                                ...
                                .subscribe(new Observer<Boolean>() {
                                    ...
                                    public void onNext(Boolean aBoolean) {
                                        if (aBoolean) {
                                            ...
                                            ToastManage.s(PictureExternalPreviewActivityC.this,getString(R.string.picture_jurisdiction));
                                        }
                                    }
    ...
    private void showDownLoadDialog(final String path) {
        final CustomDialog dialog = new CustomDialog(PictureExternalPreviewActivityC.this,
                ScreenUtils.getScreenWidth(PictureExternalPreviewActivityC.this) * 3 / 4,
                ScreenUtils.getScreenHeight(PictureExternalPreviewActivityC.this) / 4,
        ...
        btn_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isHttp) {
                    ...
                    // 有可能本地图片
                    try {
                        String dirPath = PictureFileUtils.createDir(PictureExternalPreviewActivityC.this,
    ...
    public void showLoadingImage(String urlPath) {
        try {
            ...
            String path = PictureFileUtils.createDir(PictureExternalPreviewActivityC.this,
                    System.currentTimeMillis() + ".png", directory_path);
