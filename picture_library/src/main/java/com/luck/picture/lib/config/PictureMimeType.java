...
public final class PictureMimeType {
    public static int ofAll() {
        return PictureConfigC.TYPE_ALL;
    }

    public static int ofImage() {
        return PictureConfigC.TYPE_IMAGE;
    }

    public static int ofVideo() {
        return PictureConfigC.TYPE_VIDEO;
    }

    public static int ofAudio() {
        return PictureConfigC.TYPE_AUDIO;
    }
     ...
     */
    public static boolean isLongImg(LocalMediaC media) {
        if (null != media) {
