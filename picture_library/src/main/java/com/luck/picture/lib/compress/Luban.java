...
public class Luban implements Handler.Callback {
                    ...
                    public void run() {
                        try {
                            ...
                            if (medias != null && medias.size() > 0) {
                                LocalMediaC media = medias.get(index);
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_COMPRESS_MULTIPLE_SUCCESS:
                mCompressListener.onSuccess((List<LocalMediaC>) msg.obj);
                break;
    ...
    public static class Builder {
        ...
        public Builder loadLocalMedia(List<LocalMediaC> list) {
            if (list == null) {
                list = new ArrayList<>();
            }
            this.medias = list;
            for (LocalMediaC media : list) {
