...
import static com.amkj.dmsh.constant.Url.F_TOPIC_RECOMMEND;
 ...
 */
public class FindRecommendTopicFragment extends BaseFragment {
                    ...
                    switch (view.getId()) {
                        case R.id.tv_com_art_collect_count:
                            if (userId > 0) {
                                ...
                                getLoginStatus(FindRecommendTopicFragment.this);
                            }
                            break;
    ...
    private void getRecommendData() {
        ...
        NetLoadUtils.getNetInstance().loadNetDataPost(getActivity(), F_TOPIC_RECOMMEND
