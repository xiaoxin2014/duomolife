...
public class FindHotTopicAdapter extends BaseQuickAdapter<FindHotTopicBean, BaseViewHolderHelper> {
    ...
    @Override
    protected void convert(BaseViewHolderHelper helper, FindHotTopicBean hotTopicBean) {
