...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void showMsg(int position, String text) {
        ...
        if (tipView != null) {
            ...
            layoutParams.leftMargin = AutoSizeUtils.mm2px(mAppContext, 74);
            layoutParams.topMargin = AutoSizeUtils.mm2px(mAppContext, 10);
            tipView.setTextColor(getResources().getColor(R.color.white));
            tipView.setBackgroundColor(getResources().getColor(R.color.yellow_bg_ffae));
            tipView.setGravity(Gravity.CENTER);
            tipView.setTextSize(8);
            tipView.setLayoutParams(layoutParams);
            tipView.setPadding(10, 5, 10, 5);
