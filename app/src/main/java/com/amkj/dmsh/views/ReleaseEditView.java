 ...
 * class description:发布编辑框
 */

public class ReleaseEditView extends EmojiconEditText {
    ...
    public ReleaseEditView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ReleaseEditView(Context context, AttributeSet attrs, int defStyle) {
