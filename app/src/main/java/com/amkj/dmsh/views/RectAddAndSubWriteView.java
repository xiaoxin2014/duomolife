...
public class RectAddAndSubWriteView extends LinearLayout {
     ...
     * 构造方法
     */
    public RectAddAndSubWriteView(Context context) {
        super(context);
     ...
     * @param
     */
    public RectAddAndSubWriteView(Context context, int num) {
        super(context);
        setOrientation(VERTICAL);
        this.context = context;
        this.num = num;
    ...
    public RectAddAndSubWriteView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setOrientation(VERTICAL);
        num = 1;
        control();
    ...
    private void initView() {
        view = LayoutInflater.from(context).inflate(R.layout.layout_add_sub_view_write, this, false);
        ...
        editText = (EditText) view.findViewById(R.id.tv_integration_details_credits_count);
                ...
                if (v.getId() == R.id.img_integration_details_credits_add) {
                    if (++num > maxNum) {
                        ...
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onMaxQuantity(RectAddAndSubWriteView.this,num);
                        }
                    } else {
                        if (isAutoChangeNum) {
                            setNum(num);
                        ...
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onNumChange(RectAddAndSubWriteView.this, TYPE_ADD, getNum());
                        }
                    }
                    ...
                    if (--num < 1) {
                        ...
                        editText.setText(String.valueOf(num));
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onNumChange(RectAddAndSubWriteView.this, TYPE_SUBTRACT, getNum());
                        }
                    } else {
                        if (isAutoChangeNum) {
                            editText.setText(String.valueOf(num));
