...
public class RefreshHeader extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStatusImageView.setImageResource(R.drawable.blank);
    ...
    public void updateRefreshStatus(int status) {
        ...
        if (status == XCPullToLoadMoreListView.REFRESH_STATUS_REFRESH_FINISH || status == XCPullToLoadMoreListView.REFRESH_STATUS_NO_MORE) {
            mProgressView.setVisibility(View.GONE);
        }
        if (status == XCPullToLoadMoreListView.REFRESH_STATUS_PULL_REFRESH
