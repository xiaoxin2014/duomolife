...
public class BannerIndicator extends LinearLayout {
    ...
    public BannerIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        dashGap = (int) array.getDimension(R.styleable.BannerIndicator_gap, AutoSizeUtils.dp2px(mAppContext, 3));
        slider_width = (int) array.getDimension(R.styleable.BannerIndicator_slider_width,
                AutoSizeUtils.dp2px(mAppContext, 12));
        slider_height = (int) array.getDimension(R.styleable.BannerIndicator_slider_height, AutoSizeUtils.dp2px(mAppContext, 4));
