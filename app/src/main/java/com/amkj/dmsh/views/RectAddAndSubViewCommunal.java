...
public class RectAddAndSubViewCommunal extends AutoLinearLayout {
     ...
     * 构造方法
     */
    public RectAddAndSubViewCommunal(Context context) {
        super(context);
     ...
     * @param
     */
    public RectAddAndSubViewCommunal(Context context, int num) {
        super(context);
        this.context = context;
        this.num = num;
        control();
    ...
    public RectAddAndSubViewCommunal(Context context, AttributeSet attrs) {
        super(context, attrs);
        num = 1;
        control();
    }
                ...
                if (v.getId() == R.id.img_integration_details_credits_add) {
                    if (num + 1 > maxNum) {
                        ...
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onNumChange(RectAddAndSubViewCommunal.this, TYPE_ADD, num + 1, num);
                        }
                    } else {
                        ++num;
                        if (isAutoChangeNum) {
                        ...
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onNumChange(RectAddAndSubViewCommunal.this, TYPE_ADD, num, num - 1);
                        }
                    }
                    ...
                    if (num - 1 < minNum) {
                        ...
                        if (onNumChangeListener != null) {
                            onNumChangeListener.onNumChange(RectAddAndSubViewCommunal.this, TYPE_SUBTRACT, num, num + 1);
                        }
                    }
                }
            }
