...
public class QualityProductActActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        qualityTypeProductAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
                if (page * DEFAULT_TOTAL_COUNT <= actProActivityList.size()) {
                    page++;
        ...
        badge = ConstantMethod.getBadge(QualityProductActActivity.this, fl_header_service);
    ...
    private void getActProActivityData() {
        ...
        if (NetWorkUtils.checkNet(QualityProductActActivity.this)) {
            ...
            XUtil.Post(url, params, new MyCallBack<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    if (likedProductEntity != null) {
                        ...
                        if (page == 1) {
                            qualityTypeProductAdapter.setNewData(actProActivityList);
                        } else {
