...
public class CatergoryTwoLevelActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        communal_recycler.setLayoutManager(new GridLayoutManager(CatergoryTwoLevelActivity.this, 2));
        ...
        qualityTypeProductAdapter = new QualityTypeProductAdapter(CatergoryTwoLevelActivity.this, typeDetails);
        headerAdView = LayoutInflater.from(CatergoryTwoLevelActivity.this).inflate(R.layout.layout_al_new_sp_banner, null, false);
        childTypeHeaderView = LayoutInflater.from(CatergoryTwoLevelActivity.this).inflate(R.layout.layout_communal_recycler_wrap, null, false);
        ...
        qualityTypeProductAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            if (likedProductBean != null) {
                Intent intent1 = new Intent(CatergoryTwoLevelActivity.this, ShopScrollDetailsActivity.class);
                ...
                if (userId > 0) {
                    switch (view.getId()) {
                        case R.id.iv_pro_add_car:
                            ...
                            constantMethod.addShopCarGetSku(CatergoryTwoLevelActivity.this, baseAddCarProInfoBean, loadHud);
                            break;
                    }
                } else {
                    loadHud.dismiss();
                    getLoginStatus(CatergoryTwoLevelActivity.this);
                }
            }
        });
        ...
        typeSortView = LayoutInflater.from(CatergoryTwoLevelActivity.this).inflate(R.layout.layout_type_sort_text_header, null, false);
    ...
    private void openCloseTypeSelector(final int tabPosition, final boolean isReselect) {
        if (bottomPopWindows == null) {
            bottomPopWindows = new BottomPopWindows(CatergoryTwoLevelActivity.this);
            ...
            communal_recycler_wrap.setLayoutManager(new GridLayoutManager(CatergoryTwoLevelActivity.this, 4));
...
//            重新设置child数据
            ...
            public void onSuccess(String result) {
                ...
                if (qualityAdLoop != null) {
                    if (qualityAdLoop.getCode().equals(SUCCESS_CODE)) {
                        ...
                        if (cbViewHolderCreator == null) {
                            cbViewHolderCreator = new CBViewHolderCreator() {
                                ...
                                public Holder createHolder(View itemView) {
                                    return new CommunalAdHolderView(itemView, CatergoryTwoLevelActivity.this, true);
                                }
                        ...
                        qTypeView.ad_communal_banner.setPages(CatergoryTwoLevelActivity.this, cbViewHolderCreator, adBeanList).setCanLoop(true)
    ...
    private void getSortType() {
        if (sortTypeList.size() < 1) {
            NetLoadUtils.getNetInstance().loadNetDataPost(CatergoryTwoLevelActivity.this, Q_SORT_TYPE,
...
//                                    获取子类
                        ...
                        public void netClose() {
                            showToast(CatergoryTwoLevelActivity.this, R.string.unConnectedNetwork);
                        }

                        @Override
                        public void onError(Throwable throwable) {
                            showToast(CatergoryTwoLevelActivity.this, R.string.request_json_data_error);
                        }
                    });
        } else {
//          获取子类
    ...
    private void getQualityTypePro() {
        ...
        NetLoadUtils.getNetInstance().loadNetDataPost(CatergoryTwoLevelActivity.this, Q_PRODUCT_TYPE_LIST
                , params, new NetLoadListenerHelper() {
                        ...
                        if (likedProductEntity != null) {
                            if (likedProductEntity.getCode().equals(SUCCESS_CODE)) {
                                ...
                                if (!EMPTY_CODE.equals(likedProductEntity.getCode())) {
                                    showToast(CatergoryTwoLevelActivity.this, likedProductEntity.getMsg());
                                }
                            }
                            if (page == 1) {
                    ...
                    @Override
                    public void onError(Throwable throwable) {
                        showToast(CatergoryTwoLevelActivity.this, R.string.invalidData);
                    }
                });
    }
    ...
    private void getChildrenType() {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("pid", categoryId);
        NetLoadUtils.getNetInstance().loadNetDataPost(CatergoryTwoLevelActivity.this, Q_PRODUCT_TYPE,
                params, new NetLoadListenerHelper() {
                    @Override
                    public void onSuccess(String result) {
                        childTypeList.clear();
