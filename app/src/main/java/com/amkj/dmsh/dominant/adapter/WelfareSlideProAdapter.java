...
public class WelfareSlideProAdapter extends BaseQuickAdapter<ProductListBean, BaseViewHolderHelper> {
    ...
    @Override
    protected void convert(BaseViewHolderHelper helper, ProductListBean productListBean) {
