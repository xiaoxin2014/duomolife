...
public class QualityActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        productTypeSpecificAdapter = new QualityProductTypeSpecificAdapter(QualityActivity.this, qualityTypeSpecificBeanList);
        ...
        productTypeSpecificAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            if (qualityTypeBean != null) {
                Intent intent = new Intent(QualityActivity.this, QualityTypeProductActivity.class);
...
//        良品侧边栏分类
        rv_quality_product_type.setLayoutManager(new LinearLayoutManager(QualityActivity.this));
    ...
    private void getFloatAd() {
        if (NetWorkUtils.checkNet(QualityActivity.this)) {
                    ...
                    if (floatAdEntity != null) {
                        if (floatAdEntity.getCode().equals("01")) {
                            if (floatAdEntity.getCommunalADActivityBean() != null) {
                                ...
                                GlideImageLoaderUtil.loadFitCenter(QualityActivity.this, iv_float_ad_icon,
                ...
                public void onSuccess(String result) {
                    ...
                    if (requestStatus != null) {
                        if (requestStatus.getCode().equals("01")) {
                            ...
                            showToast(QualityActivity.this, requestStatus.getMsg());
                        }
                    }
                }
            });
    ...
    private void getQualityHorType() {
        ...
        if (NetWorkUtils.isConnectedByState(QualityActivity.this)) {
...
//                判断当前网络是否连接
                    return !NetWorkUtils.isConnectedByState(QualityActivity.this); //true: 信任缓存数据, 不再发起网络请求; false不信任缓存数据
                }
...
//                    showToast(x.app(), ex.getMessage());
                    ...
                    if (hasCache) {
                        showToast(QualityActivity.this, R.string.unConnectedNetwork);
                    }
                }
    ...
    private void getTypeHorDataJson(String result) {
        ...
        if (typeBean != null) {
            if (typeBean.getCode().equals("01")) {
                ...
                showToast(QualityActivity.this, typeBean.getMsg());
            }
        }
    }
...
//                    showToast(x.app(), result);
    ...
    private void getTypeDataJson(String result) {
        ...
        if (typeBean != null) {
            if (typeBean.getCode().equals("01")) {
                ...
                showToast(QualityActivity.this, R.string.invalidData);
            } else {
                showToast(QualityActivity.this, typeBean.getMsg());
            }
        }
    ...
    private void setSlideData(List<QualityTypeBean> qualityTypeBeanList) {
        if (qualityTypeBeanList.size() > 0) {
            ...
            QualityPageAdapter qualityPageAdapter = new QualityPageAdapter(getSupportFragmentManager(), qualityTypeBeanList);
    ...
    void goSearch(View view) {
        Intent intent = new Intent(QualityActivity.this, HomePageSearchActivity.class);
    ...
    void skipShopCar(View view) {
        Intent intent = new Intent(QualityActivity.this, ShopCarActivity.class);
        startActivity(intent);
    }
    ...
    void floatAdSkip(View view) {
        ...
        if (communalADActivityBean != null) {
            ...
            ConstantMethod.setSkipPath(QualityActivity.this, getStrings(communalADActivityBean.getAndroidLink()), false);
        }
    }
}
