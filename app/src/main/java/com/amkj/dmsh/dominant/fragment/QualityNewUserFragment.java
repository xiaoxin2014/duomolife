...
//        qualityNewUserShopAdapter = new QualityNewUserShopAdapter(getActivity(), qualityNewUserShopList);
    ...
    private void getCoverImg() {
        NetLoadUtils.getNetInstance().loadNetDataPost(getActivity(), QUALITY_NEW_USER_COVER, new NetLoadListenerHelper() {
            @Override
            public void onSuccess(String result) {
                ...
                if (requestStatus != null) {
                    if (requestStatus.getCode().equals(SUCCESS_CODE)) {
                        ...
                        GlideImageLoaderUtil.loadImgDynamicDrawable(getActivity(), qNewUserCoverHelper.iv_new_user_cover,
...
//                        qualityNewUserShopBean.setcTitle("- 用券专区 -");
    ...
    class QNewUserCoverHelper {
        ...
        public void initViews() {
            ...
            newUserCouponAdapter = new NewUserCouponAdapter(getActivity(), couponGiftList);
