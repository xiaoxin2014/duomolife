...
//        配置七鱼点击通知栏
        statusBarNotificationConfig.notificationEntrance = ServiceReceiverActivity.class;
    ...
    public void openQyServiceChat(Context context, String sourceTitle, String sourceUrl,QyProductIndentInfo qyProductIndentInfo) {
        ...
        if(qyProductIndentInfo!=null){
            if(pageSource==null){
                pageSource = new ConsultSource("","","");
            }
//            ProductDetail productDetail = ProductDetail.Builder;
//            pageSource.productDetail = productDetail;
        }
        /**
...
//            array.add(userInfoDataItem("email", email, -1,null, null)); // email
            ...
            array.add(userInfoDataItem("system_version", osVersion, 0, "手机系统版本", null));
            array.add(userInfoDataItem("app_version", getVersionName(context), 1, "app当前版本", null));
