                    ...
                    if (communalRuleEntity.getCode().equals(SUCCESS_CODE)) {
                        if (communalRuleEntity.getCommunalRuleList() != null
                            ...
                            if (alertLotteryRuleDialogHelper == null) {
                                alertLotteryRuleDialogHelper = new AlertRuleDialogHelper(getActivity());
                            }
                    ...
                    if (communalRuleEntity.getCode().equals(SUCCESS_CODE)) {
                        if (communalRuleEntity.getCommunalRuleList() != null
                            ...
                            if (alertIntegralRuleDialogHelper == null) {
                                alertIntegralRuleDialogHelper = new AlertRuleDialogHelper(getActivity());
                            }
...
//            代表七天数据
    ...
    public class AttendanceIntegralLottery {
        ...
        public void initViews() {
            ...
            integralLotteryAdapter = new IntegralLotteryAdapter(getActivity(), constantMethod, integralLotteryList);
    ...
    public class IntegralDoubleHelper {
        ...
        public void initViews() {
            ...
            rv_integral_double.addItemDecoration(new ItemDecoration.Builder()
                    ...
                    .create());
            qualityCustomTopicAdapter = new QualityCustomTopicAdapter(getActivity(), doubleIntegrationList);
