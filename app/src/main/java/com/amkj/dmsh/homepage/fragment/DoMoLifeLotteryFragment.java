 ...
 */
public class DoMoLifeLotteryFragment extends BaseFragment {
    ...
    protected void initViews() {
        mTlWebNormalBar.setVisibility(View.GONE);
...
//        js交互
        web_communal.addJavascriptInterface(new JsData(getActivity()), "JsToAndroid");
        smart_web_refresh.setOnRefreshListener(refreshLayout -> loadData());
        //设置Web视图
    ...
    private void getLotteryTime() {
        ...
        NetLoadUtils.getNetInstance().loadNetDataPost(getActivity(), H_HOT_ACTIVITY_ADD_LOTTERY, params, new NetLoadListenerHelper() {
            @Override
...
//                    刷新抽奖次数
            ...
            public void netClose() {
                Toast.makeText(getActivity(), R.string.unConnectedNetwork, Toast.LENGTH_SHORT).show();
            }
        });
    }
