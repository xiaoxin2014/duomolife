 ...
 */
public class IntegralLotteryAwardAdapter extends BaseQuickAdapter<LotteryInfoListBean, BaseViewHolderHelper> {
    ...
    @Override
    protected void convert(BaseViewHolderHelper helper, LotteryInfoListBean lotteryInfoListBean) {
