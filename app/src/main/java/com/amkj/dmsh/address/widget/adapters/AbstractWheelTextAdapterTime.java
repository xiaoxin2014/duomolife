 ...
 */
package com.amkj.dmsh.address.widget.adapters;
 ...
 */
public abstract class AbstractWheelTextAdapterTime extends AbstractWheelAdapter {
     ...
     */
    protected AbstractWheelTextAdapterTime(Context context) {
     ...
     */
    protected AbstractWheelTextAdapterTime(Context context, int itemResource) {
     ...
     */
    protected AbstractWheelTextAdapterTime(Context context, int itemResource, int itemTextResource, int currentIndex,
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, maxsize);
                } else {
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, minsize);
                }
