...
public class DirectProductListAdapter extends BaseQuickAdapter<Object, BaseViewHolder> {
    ...
    public DirectProductListAdapter(Activity context, List list, String type) {
        super((INDENT_W_TYPE.equals(type) || INDENT_GROUP_SHOP.equals(type))
                ? R.layout.layout_direct_indent_product_item : R.layout.layout_direct_indent_product_new_item, list);
...
//                            .addOnClickListener(R.id.ll_communal_activity_topic_tag).setTag(R.id.ll_communal_activity_topic_tag, orderProductInfoBean);
            ...
            //申请退款
            case APPLY_REFUND:
                RefundApplyEntity.RefundApplyBean.ProductsBean productsBean = (RefundApplyEntity.RefundApplyBean.ProductsBean) item;
...
//                            .addOnClickListener(R.id.ll_communal_activity_tag_rule).setTag(R.id.ll_communal_activity_tag_rule, productInfoBean);
            ...
            case INDENT_GROUP_SHOP:
                ...
                helper.setText(R.id.tv_direct_indent_pro_name, getStrings(groupProductInfoBean.getName()))
                        ...
                        .setGone(R.id.tv_move, !TextUtils.isEmpty(groupProductInfoBean.getNotBuyAreaInfo()))
                        .addOnClickListener(R.id.rl_cover).setTag(R.id.rl_cover, groupProductInfoBean)
