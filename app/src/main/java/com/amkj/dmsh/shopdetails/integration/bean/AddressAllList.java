...
public class AddressAllList {
    ...
    private List<AddressAllBean> addressAllBeanList;
    ...
    public List<AddressAllBean> getAddressAllBeanList() {
        return addressAllBeanList;
    }

    public void setAddressAllBeanList(List<AddressAllBean> addressAllBeanList) {
