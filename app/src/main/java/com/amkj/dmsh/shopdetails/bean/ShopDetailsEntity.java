...
public class ShopDetailsEntity extends BaseEntity {
    ...
    public static class ShopPropertyBean {
        ...
        public static class CouponJsonBean {
            ...
            public static ShopDetailsEntity2.ShopPropertyBean.CouponJsonBean objectFromData(String str) {

                return new Gson().fromJson(str, ShopDetailsEntity2.ShopPropertyBean.CouponJsonBean.class);
            }
