 ...
 */
public class NewShopScrollDetailsActivity extends BaseActivity {
...
//        商品名字
    ...
    private CharSequence getChNText(String priceText) {
        ...
        link.setUnderlined(false);
        link.setHighlightAlpha(0f);
        return LinkBuilder.from(NewShopScrollDetailsActivity.this, priceText)
                .addLink(link)
                .build();
    }
...
//                跳转更多评论
    ...
    private void skipMoreRecommend(ShopRecommendHotTopicBean shopRecommendHotTopicBean) {
        Intent intent = new Intent(NewShopScrollDetailsActivity.this, ProRecommendActivity.class);
