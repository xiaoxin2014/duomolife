...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "domolife";
    private static String CALENDARS_ACCOUNT_NAME = "domolife_product";
    private static String CALENDARS_ACCOUNT_TYPE = "domolife_remind";
    private static String CALENDARS_DISPLAY_NAME = "domolife_display";
