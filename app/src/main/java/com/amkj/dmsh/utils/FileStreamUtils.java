...
public class FileStreamUtils {
    ...
    public static boolean forChannel(File f1, File f2) throws Exception {
        int length = 2097152;
     ...
     * @return
     */
    public static String InputStreamTOString(InputStream in, @NonNull String encoding) {
