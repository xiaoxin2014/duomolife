...
public class MesPushTypeSetAdapter extends BaseQuickAdapter<MesPushTypeBean, BaseViewHolderHelper> {
    public MesPushTypeSetAdapter(List<MesPushTypeBean> data) {
        super(R.layout.adapter_mes_push_type_clo_open, data);
    }

    @Override
    protected void convert(BaseViewHolderHelper helper, MesPushTypeBean mesPushTypeBean) {
